...
const EmailVerify = () => {
  ...
  return (
    <div className='flex items-center justify-center min-h-screen bg-gradient-to-br from-blue-200 to-purple-400'>
      ...
      <form onSubmit={onSubmitHandler} class='bg-slate-900 p-8 rounded-lg shadow-lg w-96 text-sm'>
      <h1 class='text-white text-2xl font-semibold text-center mb-4'>Email Verify OTP</h1>
